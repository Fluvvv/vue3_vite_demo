      ...
      <div class="content">
        <el-form :model="passForm" :rules="rules" ref="validateForm" label-width="100px">
          <el-form-item label="原始密码" prop="oldPassword">
            <el-input class="input-size" type="password" v-model="passForm.oldPassword" prefix-icon="el-icon-lock" autocomplete="off" />
          </el-form-item>
          <el-form-item label="新密码" prop="password">
            <el-input class="input-size" type="password" v-model="passForm.password" prefix-icon="el-icon-lock" autocomplete="off" />
          </el-form-item>
          <el-form-item label="确认密码" prop="rePassword">
            <el-input class="input-size" type="password" v-model="passForm.rePassword" prefix-icon="el-icon-lock" autocomplete="off" />
          </el-form-item>
          <el-form-item>
