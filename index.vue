<template>
  <div class="cockpit">
    ...
    <div class="data_collect marBo20">
      <div :class="['collect_box', 'box_shadow', { marTop15: index > 2 }]" v-for="(item, index) in collectData" :key="item">
        <div class="icon_box">
        ...
        <div class="text_box">
          <div>
            ...
            <p class="nowMoney">
              {{ item.nowMoney }}
              {{ item.unit }}
              <span class="rate_add" v-if="item.rate >= 0">(+{{ item.rate }}%)</span>
    ...
    <div class="lineChart_container marBo20">
      ...
      <div class="wait_thing box_shadow">
        ...
        <ul>
          <li class="news_li" :style="[{ 'border-bottom': index === waitData.length - 1 && 'none' }]" v-for="(item, index) in waitData" :key="index">
